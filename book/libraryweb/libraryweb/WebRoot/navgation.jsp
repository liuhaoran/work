...
<%      
		...
		if(pageNow>1){
%>
		<a style="text-decoration:none;" href="ReaderInfoServlet?action=queryreader&query=query&pageNow=<%= pageNow-1 %>"><上一页></a>
<%
		}
%>
		</td>
	<form action="ReaderInfoServlet?action=queryreader&query=query" method="post">
...
%>
		<a style="text-decoration:none;" href="ReaderInfoServlet?action=queryreader&query=query&pageNow=<%= pageNow+1 %>">下一页>></a>
<%
		}
%>
		</td>
